    ...
    public class OrderItemsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.OrderItem != null ? 
                          ...
                          Problem("Entity set 'AppDbContext.OrderItem'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id")] OrderItem orderItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id")] OrderItem orderItem)
        {
            if (id != orderItem.Id)
            {
                return NotFound();
